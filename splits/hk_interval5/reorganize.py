...
# 定义文件路径
for splits in ['test']:
    train_files_path = f"/Workspace/Baselines/monodepth2_finetune_ac_rema_intervals/splits/hk/{splits}_files.txt"
    new_train_files_path = f"/Workspace/Baselines/monodepth2_finetune_ac_rema_intervals/splits/hk_interval5/{splits}_files_interval20.txt"
