...
for splits in ['train', 'val', 'test']:
    train_files_path = f"/Workspace/FEAST/monodepth2_feast_ac_rema/splits/hk/{splits}_files.txt"
    new_train_files_path = f"/Workspace/FEAST/monodepth2_feast_ac_rema/splits/hk_interval30/{splits}_files.txt"
